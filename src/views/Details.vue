      ...
      <div class="container mb-5">
        <div class="row pr-3">
          ...
          <div id="details" class="col pl-0">
            ...
            <h6>
              <a class="small text-dark font-weight-bold" href="javascript:;"  id="p_sub_title" v-text="product.p_sub_title"></a>
            </h6>
            <div class="alert alert-secondary small" role="alert">
              <div>
                <span>学员售价：</span>
                <h2 class="d-inline text-primary font-weight-bold"  id="pprice">￥{{product.price}}</h2>
              </div>
              <div>
                <span>服务承诺：</span>
            ...
            <div>
              ...
              <div class="float-left w-75" id="specs">
                <router-link class="btn btn-sm btn-outline-secondary" v-for="(sp,i) of specs" :key="i" :to="`/details/${sp.lid}`" v-text="sp.spec" :class="sp.lid==lid ? 'active' : '' "></router-link>
              </div>
